...
DEFAULT_FILE_STORAGE = "ian_startbx.settings.dgo.utils.MediaRootS3BotoStorage"

STATICFILES_STORAGE = "ian_startbx.settings.dgo.utils.StaticRootS3BotoStorage"
...
PRIVATE_FILE_STORAGE = "ian_startbx.settings.dgo.utils.MediaRootS3BotoStorage"
